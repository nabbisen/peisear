...
pub fn render(key: MessageKey) -> String {
    match key {
        ...
        MessageKey::PlanMovedToSprintAnnouncement => "[fx-plan-moved-to-sprint]".to_string(),
        MessageKey::PlanMovedToBacklogAnnouncement => "[fx-plan-moved-to-backlog]".to_string(),
        MessageKey::PlanUndoUnavailableMessage => "[fx-plan-undo-unavailable]".to_string(),
