...
**Covers release**: `0.37.0` (**Definition of Done item 1 reaches Met**, the
second-oldest condition in that table to move; `NFR-PRIV-008` closed; no
product behaviour changed; implementation through `0.37.0`)
