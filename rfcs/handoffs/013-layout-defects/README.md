...
| REL-0.34.0 | [REL-0.34.0](./REL-0.34.0-release-candidate.md) | Release candidate — `LAYOUT-009` + round 2, `TT-005`, `TT-006`. One user-visible fix and **two corrections to this project's own published record**, including a 0.31.0 sentence that overstated the adjacency guarantee. | 0.34.0 |
