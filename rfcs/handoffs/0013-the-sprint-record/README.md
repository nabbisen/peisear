...
| REL-0.39.0 | [REL-0.39.0](./REL-0.39.0-release-candidate.md) | Release candidate — the sprint record, five concurrency defects, reopen, and the privacy floor. **Two backfilling migrations, a narrowed aggregate, and a decision retired four days after it shipped to `main`.** `DEC-028` is a §3 gate, not a follow-up. | 0.39.0 |
