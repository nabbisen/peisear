...
| REL-0.33.0 | [REL-0.33.0](./REL-0.33.0-release-candidate.md) | Release candidate — the gate, its fixture and 320 px, `LOCK-001`, `LAYOUT-003`–`007`, `NFR-A11Y-006` Met. **After `LAYOUT-007`.** The changelog must not read as "layout is now covered". | 0.33.0 | LAYOUT-007 |
